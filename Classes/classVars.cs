...
namespace PTFLauncher
{
    public class classVars
    {
        ...
        public static string url_download_folder    = "http://WEBSITE.de/wow_clients/";
        public static string url_download_file      = "WEBSITE.de/wow_clients/tbc.zip";
        public static string ip_worldserver         = "SERVERIP";
        ...
        public static string appversion             = "0.0.92";
