...
namespace PTFLauncher
{
    public class classVars
    {
        ...
        public static string url_download_file      = "website/wow_clients/tbc.zip";
        public static string ip_worldserver         = "website_IP";
        ...
        public static string appversion             = "0.0.93";
